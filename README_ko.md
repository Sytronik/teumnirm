...
- **비활동 감지**: 3분간 입력이 없으면 타이머가 일시정지되고, 휴식 알림 간격의 절반(기본 27.5분) 이상 입력이 없으면 타이머가 완전히 초기화됩니다
- **회의 중 알림 미루기**: 마이크 사용 중이면 휴식 알림을 미루고, 마이크 사용이 끝나면 바로 휴식 알림을 표시
...
1. 메뉴바 아이콘 > **설정...** > **일반**으로 이동합니다
2. **마이크 사용 중에는 휴식 알림 미루기**를 켭니다
3. 타이머가 끝나더라도 마이크 사용 중이면 알림이 보류되고, 마이크 사용이 끝나면 즉시 휴식 알림이 나타납니다
...
- **마이크 사용 중에는 휴식 알림 미루기**: Zoom 전용 연동이 아니라, 마이크를 사용하는 앱 전반을 기준으로 동작
